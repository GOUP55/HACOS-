...
const URGENT_RULES = [
  {
    ...
    reply: (env) =>
      '話してくれてありがとうございます。あなたのことがとても心配です。今すぐみどりさんに共有します。ひとりにしません。' +
  ...
  },
  {
    ...
    reply: () =>
      '教えてくれてありがとうございます。胸の痛みやしびれは私では判断できないので、まず医療機関に相談してください。トレーナーにも今すぐ共有します。無理は絶対にしないでくださいね。',
  },
  {
    category: '服薬・持病',
    re: /薬を飲んで|服薬|持病|通院中/,
    reply: () =>
      '大切なご質問なので、私からはお答えできません。かかりつけの先生に確認していただけますか🌿 その内容をトレーナーに共有してもらえたら、無理のない形を一緒に考えます。',
  },
  {
    category: '妊娠・産後',
    re: /妊娠|産後/,
    reply: () =>
      'まずは体を大切に🌿 運動については必ず主治医に確認してください。みどりさんにも共有して、今後のことはゆっくり相談しましょう。',
  },
  {
    category: '摂食不安・嘔吐',
    re: /食べるのが怖|食べたら太る気がして|吐いて|吐いた|吐きそう|嘔吐|戻してしま/,
    reply: () =>
      '打ち明けてくれてありがとうございます。それは体と心からの大事なサインかもしれません。みどりさんにすぐ共有しますね。責めることは何もないので、安心してください🌿',
  },
  {
    category: '極端な絶食',
    ...
    reply: () =>
      '止めさせてください。長時間の絶食は体に危険が及ぶことがあり、リバウンドも起きやすい方法です。やる前にトレーナーと話しましょう。すぐ共有しますね🌿',
  },
  {
    category: 'けが',
  ...
  },
  {
    ...
    reply: () =>
      'つらい中で送ってくれてありがとうございます。あなたのことが心配です。みどりさんにすぐ共有します。よければ近いうちに直接お話ししませんか。ひとりにはしませんから🌿',
  },
];
